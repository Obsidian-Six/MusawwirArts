...
const ArtistDetail = () => {
    ...
    // NOTE: Added leading slashes to all paths so Vite serves them from /public
    const artist = {
        name: "Amol Pawar",
        ...
        portfolio: [
            ...
            },
            {
                ...
                price: "Rs. 656,000",
                isSold: true,
                image: "/uploads/artists/shiva.png" // Reusing Shiva
            }
        ]
    };
            ...
            <div className="pt-24 pb-16 flex flex-col items-center border-b border-gray-100">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden mb-6 ring-1 ring-gray-100 bg-gray-50">
                    <img 
                        ...
                        onError={(e) => console.error("Failed to load profile image:", e.target.src)}
                    />
                </div>
                        ...
                        <div key={index} className="group flex flex-col">
                            ...
                            <div className="relative aspect-[3/4] overflow-hidden bg-gray-50 mb-6">
                                <img 
                                    ...
                                    // Added loading eager to prioritize these images
                                    loading="eager"
                                    onError={(e) => console.error("Failed to load portfolio image:", e.target.src)}
                                />
