        ...
        <>
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .underline-animate::after {
                    ...
                    width: 0;
                    height: 2px;
                    bottom: -6px; /* Moved down slightly to accommodate larger text */
                    left: 0;
            ...
            <header className="w-full bg-white font-sans border-b border-gray-100 relative z-50">
                ...
                <div className="bg-[#A6894B] text-white py-2.5 px-4 flex justify-center items-center relative">
                    <a href="tel:+971557430228" className="text-[12px] font-bold tracking-[0.3em] uppercase underline-animate text-center">
                ...
                <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-24 py-6 md:py-8">
                    <div className="grid grid-cols-3 items-center">
                        ...
                        {/* LEFT: Core Navigation - BIG TEXT */}
                        <div className="hidden md:flex items-center">
                            <nav className="flex items-center gap-12 lg:gap-16 text-[18px] font-black uppercase tracking-[0.2em] text-stone-900">
                        ...
                        <div className="flex items-center justify-end">
                            <nav className="hidden md:block text-[18px] font-black uppercase tracking-[0.2em] text-stone-900">
                                <Link to="/blog" className="hover:text-[#A6894B] transition-colors underline-animate">Blog</Link>
                            </nav>
                        </div>
                    </div>

                    {/* 3. MOBILE ONLY NAVIGATION - Larger text for mobile */}
                    <nav className="flex md:hidden justify-between items-center mt-6 pt-5 border-t border-stone-100 text-[14px] font-black uppercase tracking-[0.2em] text-stone-900 px-2">
