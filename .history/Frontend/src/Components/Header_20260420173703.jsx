                    ...
                    <div className="grid grid-cols-3 items-center">
                        ...
                        <div className="flex items-center justify-end gap-6 sm:gap-8 text-gray-800">
                            ...
                            <div className="flex items-center gap-4 sm:gap-6 text-gray-600">
                                <Search size={19} strokeWidth={1.5} className="cursor-pointer hover:text-[#A6894B] transition-colors" />
                                <ShoppingBag size={19} strokeWidth={1.5} className="cursor-pointer hover:text-[#A6894B] transition-colors" />
                            </div>
                        </div>
                    </div>
