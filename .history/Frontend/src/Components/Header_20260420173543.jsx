...
const Header = () => { 
    const navigate = useNavigate(); // Controls the dropdown
        ...
        <>
            ...
            <header className="w-full bg-white font-sans border-b border-gray-100 relative z-50">
                ...
                <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-24 py-3 md:py-3">
                    <div className="grid grid-cols-3 md:grid-cols-[1.5fr_auto_1.5fr] items-center gap-2 md:gap-4">
                        ...
                        <div className="hidden md:flex items-center">
                            <nav className="flex items-center gap-8 lg:gap-14 text-[13px] font-bold uppercase tracking-[0.2em] text-gray-800">
                                ...
                                {/* <Link to='/artist/amol-pawar' className="hover:text-[#A6894B] transition-colors underline-animate">Artists</Link>  */}
                                <Link to="/aboutus" className="hover:text-[#A6894B] transition-colors hidden lg:block underline-animate">About Us</Link>
                        ...
                        {/* RIGHT: Icons */}
                        <div className="flex items-center justify-end gap-3 sm:gap-5 md:gap-7 text-gray-700">
                            <Search size={20} strokeWidth={1.2} className="cursor-pointer hover:text-[#A6894B]" />
                            
                            <div className="relative group">
                                <ShoppingBag size={20} strokeWidth={1.2} className="cursor-pointer hover:text-[#A6894B]" />
                            </div>
                            ...
                            <div className="relative">
                                <User 
                                    size={20} 
                                    strokeWidth={1.2} 
                                    className="cursor-pointer hover:text-[#A6894B]" 
                                    onClick={() => navigate('/admin/login')}
                                />
                    ...
                    <nav className="flex md:hidden justify-center gap-6 mt-4 pt-3 border-t border-gray-50 text-[9px] font-bold uppercase tracking-[0.15em] text-gray-600">
                        <Link to="/paintings" className="hover:text-[#A6894B]">Paintings</Link>
                        <Link to="/artist/amol-pawar" className="hover:text-[#A6894B]">Artists</Link>
                        <Link to="/aboutus" className="hover:text-[#A6894B]">About Us</Link>
                        <Link to="/blog" className="hover:text-[#A6894B]">Blog</Link>
                        <Link to="#" className="hover:text-[#A6894B]">Advisory</Link>
                    </nav>
                </div>
            </header>
        </>
